...
/**
 * 将消息转发到客服
 * 详细细节 https://developers.weixin.qq.com/miniprogram/introduction/custom.html#%E5%B0%86%E6%B6%88%E6%81%AF%E8%BD%AC%E5%8F%91%E5%88%B0%E5%AE%A2%E6%9C%8D
 * Examples:
 * ```
 * api.sendTransferCustomerService('openid', 'Hello world');
 * ```

 * @param {String} openid 用户的openid
 * @param {String} text 发送的消息内容
 */
exports.sendTransferCustomerService = async function (openid, text) {
  const { accessToken } = await this.ensureAccessToken();
  // {
  //  "touser":"OPENID",
  //  "msgtype":"text",
